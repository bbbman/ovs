			...
			<div class="col-md-9" style="margin-left:-8px;">
				<div class="row">
					<div class="col-lg-5" style="float:right;">
						<form action="<%=basePath%>admin/vote-manager!search.action" method="post" class="form-group">
					...
					<table class="table">
						<tbody>
							...
							<tr id="${page.pageId }">
								...
								<c:if test="${page.disable == 0 }">
								<td name="status">投票进行中</td>
								<td>
									<button type="button" class="btn btn-default operateButton" onclick="changeDisable(this);" >停止</button>
									<button type="button" class="btn btn-default operateButton" onclick="">查看</button>
								</td>
								</c:if>
								<c:if test="${page.disable != 0 }">
								<td name="status">停止</td>
								<td>
									<button type="button" class="btn btn-default operateButton" onclick="changeDisable(this);">重启</button>
									<button type="button" class="btn btn-default operateButton" onclick="">查看</button>
								</td>
								</c:if>								
							</tr>	
