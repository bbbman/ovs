...
<body>
	...
	src="<%=basePath%>/myjs/register.js"></script>
	<div class="panel" style="margin-left:150px;margin-right:400px;">
		...
		<div class="form-horizontal vote-question">
			...
			<div class="form-group">
				...
				<div class="controls">
					<input name="username" type="text" class="form-control" style="width:300px"
						placeholder="请输入昵称">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="controls">
					<input name="confPassword" type="password" class="form-control" style="width:300px"
						placeholder="请重复输入密码">
				</div>
			</div>
			<div class="form-group">
				<div class="controls">
					<button class="btn btn-default" onclick="submitRegister();">注册</button>
